// Shared Framer Motion animation variants — keep these minimal and consistent.
// All scroll animations use whileInView so they only trigger once (once: true in components).
